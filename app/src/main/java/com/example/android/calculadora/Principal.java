...
public class Principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res = (TextView) findViewById(R.id.lblResultado); //capturar el resultado.
    ...
    public void calcular(View v) {
        ...
        if (validar()) {//hay que validar aki de ultimo para que no acepte los campos nulos de los numeros.
    ...
    public void borrar(View v) {//metodo borrar
        n1.setText("");
        n2.setText("");
        res.setText("");
    ...
    public boolean validar() {//metodo de validar que no haga operaciones con 0 para los campos n1 y n2.
        ...
        if ((Double.parseDouble(n2.getText().toString()) == 0 && opcion == 3)){
            n2.setError(resources.getString(R.string.error3));
            n2.requestFocus();
            return false;
    }
    return true;
